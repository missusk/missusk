...
<span style={{ fontSize: 16, color: 'rgba(255,255,255,0.72)', fontFamily: 'monospace', lineHeight: 1.6, marginBottom: 2 }}>platform engineer at branch international</span>
...
<span style={{ fontSize: 13, color: 'rgba(217,105,83,0.85)', fontFamily: 'monospace' }}>{'> pune, india · open to remote'}</span>
...
<span style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', letterSpacing: 4, textTransform: 'uppercase', marginBottom: 26, zIndex: 10, fontFamily: 'monospace' }}>what i work on</span>
...
<span style={{ fontSize: 16, color: 'rgba(255,255,255,0.82)', lineHeight: 1.45 }}>rails internals at branch international, mostly the boring infra bits</span>
</div>
<div style={{ display: 'flex', alignItems: 'flex-start' }}>
<span style={{ color: '#d96953', fontSize: 18, marginRight: 16, fontFamily: 'monospace', lineHeight: 1.4, marginTop: -2 }}>·</span>
<span style={{ fontSize: 16, color: 'rgba(255,255,255,0.82)', lineHeight: 1.45 }}>postgres at scale: lock contention, version upgrades, slow-query archaeology</span>
</div>
<div style={{ display: 'flex', alignItems: 'flex-start' }}>
<span style={{ color: '#d96953', fontSize: 18, marginRight: 16, fontFamily: 'monospace', lineHeight: 1.4, marginTop: -2 }}>·</span>
<span style={{ fontSize: 16, color: 'rgba(255,255,255,0.82)', lineHeight: 1.45 }}>kubernetes plumbing on eks: helm, keda, kubeclient watches for dynamic config</span>
</div>
<div style={{ display: 'flex', alignItems: 'flex-start' }}>
<span style={{ color: '#d96953', fontSize: 18, marginRight: 16, fontFamily: 'monospace', lineHeight: 1.4, marginTop: -2 }}>·</span>
<span style={{ fontSize: 16, color: 'rgba(255,255,255,0.82)', lineHeight: 1.45 }}>sneakers / rabbitmq job system internals, connection recycling, pgbouncer</span>
</div>
<div style={{ display: 'flex', alignItems: 'flex-start' }}>
<span style={{ color: '#d96953', fontSize: 18, marginRight: 16, fontFamily: 'monospace', lineHeight: 1.4, marginTop: -2 }}>·</span>
<span style={{ fontSize: 16, color: 'rgba(255,255,255,0.82)', lineHeight: 1.45 }}>datadog, end to end: logs, traces, metrics, dashboards, mcp-native</span>
</div>
</div>
</div>
```
...
{['ruby on rails', 'postgresql', 'kubernetes', 'aws (eks, rds)', 'helm', 'keda', 'datadog', 'sneakers', 'rabbitmq', 'redis', 'pgbouncer', 'cloudflare'].map((tech, i) => (
...
<span style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', letterSpacing: 4, textTransform: 'uppercase', marginBottom: 14, fontFamily: 'monospace' }}>currently</span>
<span style={{ fontSize: 15, color: 'rgba(255,255,255,0.82)', lineHeight: 1.55, fontFamily: 'monospace' }}>lock-free attribute caching in rails. configmap-watched dynamic</span>
<span style={{ fontSize: 15, color: 'rgba(255,255,255,0.82)', lineHeight: 1.55, fontFamily: 'monospace' }}>config via kubeclient. postgres connection recycling overhaul.</span>
</div>
```
